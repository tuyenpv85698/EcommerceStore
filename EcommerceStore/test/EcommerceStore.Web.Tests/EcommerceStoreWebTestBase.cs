...
{
    public abstract class EcommerceStoreWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EcommerceStoreWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EcommerceStoreWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EcommerceStoreDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EcommerceStoreDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EcommerceStoreDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EcommerceStoreDbContext, Task<T>> func)
        {
            T result;
